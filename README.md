...
AWS DynamoDB Accelerator (DAX) node cluster and was configured in the backend private subnet of the US-east-1 region to avoid downtime and prevent regional outages. Similar to the US-east-1 region outage on 10/22/2025 where the DNS record was emptied causing a cascade error effecting the backend databases causing downtime. 
