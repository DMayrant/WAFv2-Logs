...
AWS DynamoDB Accelerator (DAX) node cluster and was configured in the backend privvate subnet of the US-east-1 region to avoid avoid downtime and prevent regional outages. Similar to the US-east-1 region outage on 10/22/2025 
